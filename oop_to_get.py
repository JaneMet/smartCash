...
print(f'week stst {cash_calculator.get_week_stats()}')
print(f'cash rem for td {cash_calculator.get_today_cash_remained()}')
print(f'limit blnc for today {cash_calculator.get_today_limit_balance()}')
...
print(f' calories rem for today {calories_calculator.get_calories_remained()}')
# должно напечататься
